...
async function displayAll() {
  ...
  inputResult.style.display = "none";
  if (data == undefined) {
    container.innerHTML = `<img style="margin:auto; width:200px"  src="https://c.tenor.com/a4SaQmo5EesAAAAi/iranserver-bluebot.gif"> <span style="margin-top:40px; font-size:40px; font-weight:700; color:white">Data Not Found `;
